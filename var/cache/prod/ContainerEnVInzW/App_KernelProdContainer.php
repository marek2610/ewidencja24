...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            ...
            'App\\Controller\\AgroController' => 'getAgroControllerService',
            'App\\Controller\\DokumentyController' => 'getDokumentyControllerService',
            ...
            'console.command.public_alias.App\\Command\\ExpireUserCommand' => 'getExpireUserCommandService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/DataTermin.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/RodzajDokument.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/StatusDokument.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/StatusMessage.php';
            include_once \dirname(__DIR__, 4).'/src/Twig/StatusUser.php';
    ...
    /*
     * Gets the public 'App\Controller\AgroController' shared autowired service.
     *
     * @return \App\Controller\AgroController
     */
    protected function getAgroControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/AgroController.php';

        $this->services['App\\Controller\\AgroController'] = $instance = new \App\Controller\AgroController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\AgroController', $this));

        return $instance;
    }

    /*
     * Gets the public 'App\Controller\DokumentyController' shared autowired service.
     *
     * @return \App\Controller\DokumentyController
     */
    protected function getDokumentyControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/DokumentyController.php';

        $this->services['App\\Controller\\DokumentyController'] = $instance = new \App\Controller\DokumentyController();

        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\DokumentyController', $this));
    ...
    protected function getPaymentControllerService()
    {
        ...
        $instance->setContainer(($this->privates['.service_locator.pNNo5z3'] ?? $this->get_ServiceLocator_PNNo5z3Service())->withContext('App\\Controller\\PaymentController', $this));
    ...
    protected function getCache_AppService()
    {
        ...
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('zz9-lwSfFQ', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('IVl9YMaCVo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    /*
     * Gets the public 'console.command.public_alias.App\Command\ExpireUserCommand' shared autowired service.
     *
     * @return \App\Command\ExpireUserCommand
     */
    protected function getExpireUserCommandService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/console/Command/Command.php';
        include_once \dirname(__DIR__, 4).'/src/Command/ExpireUserCommand.php';

        return $this->services['console.command.public_alias.App\\Command\\ExpireUserCommand'] = new \App\Command\ExpireUserCommand($this);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\DokumentRepository' => ['privates', 'App\\Repository\\DokumentRepository', 'getDokumentRepositoryService', false],
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\DataTermin());
        $instance->addExtension(new \App\Twig\RodzajDokument());
        $instance->addExtension(new \App\Twig\StatusDokument());
        $instance->addExtension(new \App\Twig\StatusMessage());
        $instance->addExtension(new \App\Twig\StatusUser());
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension(new \Knp\Bundle\PaginatorBundle\Twig\Extension\PaginationExtension(new \Knp\Bundle\PaginatorBundle\Helper\Processor($c, $a)));
        $instance->addExtension(new \EasyCorp\Bundle\EasyAdminBundle\Twig\EasyAdminTwigExtension(($this->services['easyadmin.config.manager'] ?? $this->getEasyadmin_Config_ManagerService()), ($this->services['easyadmin.property_accessor'] ?? $this->getEasyadmin_PropertyAccessorService()), ($this->services['easyadmin.router'] ?? $this->getEasyadmin_RouterService()), false, $d, $a, ($this->services['easyadmin.security.authorization_checker'] ?? $this->getEasyadmin_Security_AuthorizationCheckerService())));
    ...
    /*
     * Gets the private '.errored..service_locator.U9RtBWL.App\Entity\Message' shared service.
     *
    ...
    protected function getMessageService()
    {
        ...
        return $this->privates['.errored..service_locator.U9RtBWL.App\\Entity\\Message'] = new \App\Entity\Message();
    }
    ...
    /*
     * Gets the private '.errored..service_locator.rlHp78c.App\Entity\Dokument' shared service.
     *
     * @return \App\Entity\Dokument
     */
    protected function getDokumentService()
    {
        include_once \dirname(__DIR__, 4).'/src/Entity/Dokument.php';

        return $this->privates['.errored..service_locator.rlHp78c.App\\Entity\\Dokument'] = new \App\Entity\Dokument();
    }
    ...
    /*
     * Gets the private '.service_locator.DTVd5hp' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_DTVd5hpService()
    {
        return $this->privates['.service_locator.DTVd5hp'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'dokumentRepository' => ['privates', 'App\\Repository\\DokumentRepository', 'getDokumentRepositoryService', false],
        ], [
            'dokumentRepository' => 'App\\Repository\\DokumentRepository',
        ]);
    }

    /*
     * Gets the private '.service_locator.SZ.XAwj' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_SZ_XAwjService()
    {
        return $this->privates['.service_locator.SZ.XAwj'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'encodePassword' => ['services', 'security.password_encoder', 'getSecurity_PasswordEncoderService', false],
        ], [
            'encodePassword' => '?',
        ]);
    }
    ...
    /*
     * Gets the private '.service_locator.U9RtBWL' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_U9RtBWLService()
    {
        return $this->privates['.service_locator.U9RtBWL'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'message' => ['privates', '.errored..service_locator.U9RtBWL.App\\Entity\\Message', NULL, 'Cannot autowire service ".service_locator.U9RtBWL": it references class "App\\Entity\\Message" but no such service exists.'],
        ], [
    ...
    /*
     * Gets the private '.service_locator.gsw_Zt2' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_GswZt2Service()
    {
        return $this->privates['.service_locator.gsw_Zt2'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    /*
     * Gets the private '.service_locator.rCwZnnP' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RCwZnnPService()
    {
        return $this->privates['.service_locator.rCwZnnP'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'dokumentRepository' => ['privates', 'App\\Repository\\DokumentRepository', 'getDokumentRepositoryService', false],
    ...
    /*
     * Gets the private '.service_locator.rlHp78c' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_RlHp78cService()
    {
        return $this->privates['.service_locator.rlHp78c'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'dokument' => ['privates', '.errored..service_locator.rlHp78c.App\\Entity\\Dokument', NULL, 'Cannot autowire service ".service_locator.rlHp78c": it references class "App\\Entity\\Dokument" but no such service exists.'],
        ], [
            'dokument' => 'App\\Entity\\Dokument',
        ]);
    }

    /*
     * Gets the private 'App\Form\DokumentType' shared autowired service.
     *
     * @return \App\Form\DokumentType
     */
    protected function getDokumentTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/DokumentType.php';

        return $this->privates['App\\Form\\DokumentType'] = new \App\Form\DokumentType();
    }
    ...
    /*
     * Gets the private 'App\Form\UserAdminEditType' shared autowired service.
     *
     * @return \App\Form\UserAdminEditType
     */
    protected function getUserAdminEditTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/UserAdminEditType.php';

        return $this->privates['App\\Form\\UserAdminEditType'] = new \App\Form\UserAdminEditType();
    }
    ...
    /*
     * Gets the private 'App\Repository\DokumentRepository' shared autowired service.
     *
     * @return \App\Repository\DokumentRepository
     */
    protected function getDokumentRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/DokumentRepository.php';

        return $this->privates['App\\Repository\\DokumentRepository'] = new \App\Repository\DokumentRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    protected function getArgumentResolver_ServiceService()
    {
        ...
        return $this->privates['argument_resolver.service'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\ServiceValueResolver(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Controller\\AdminController::dodajUsersAdmin' => ['privates', '.service_locator.hszs.DW', 'get_ServiceLocator_Hszs_DWService', false],
            'App\\Controller\\AdminController::dokumenty' => ['privates', '.service_locator.DTVd5hp', 'get_ServiceLocator_DTVd5hpService', false],
            'App\\Controller\\AdminController::editUserAdmin' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\AdminController::infoUserAdmin' => ['privates', '.service_locator.VPb8Zl0', 'get_ServiceLocator_VPb8Zl0Service', false],
            'App\\Controller\\DokumentyController::daneDokumenty' => ['privates', '.service_locator.rCwZnnP', 'get_ServiceLocator_RCwZnnPService', false],
            'App\\Controller\\DokumentyController::deleteDokument' => ['privates', '.service_locator.rlHp78c', 'get_ServiceLocator_RlHp78cService', false],
            'App\\Controller\\DokumentyController::detailsDokumenty' => ['privates', '.service_locator.rlHp78c', 'get_ServiceLocator_RlHp78cService', false],
            'App\\Controller\\DokumentyController::detailsMiesiecznyDokumenty' => ['privates', '.service_locator.rCwZnnP', 'get_ServiceLocator_RCwZnnPService', false],
            'App\\Controller\\DokumentyController::edytujDokumenty' => ['privates', '.service_locator.rlHp78c', 'get_ServiceLocator_RlHp78cService', false],
            'App\\Controller\\DokumentyController::indexDokumenty' => ['privates', '.service_locator.rCwZnnP', 'get_ServiceLocator_RCwZnnPService', false],
            'App\\Controller\\DokumentyController::testDokumenty' => ['privates', '.service_locator.DTVd5hp', 'get_ServiceLocator_DTVd5hpService', false],
            'App\\Controller\\DokumentyController::testDokumentyId' => ['privates', '.service_locator.DTVd5hp', 'get_ServiceLocator_DTVd5hpService', false],
            'App\\Controller\\DokumentyController::usunDokument' => ['privates', '.service_locator.rlHp78c', 'get_ServiceLocator_RlHp78cService', false],
            'App\\Controller\\DokumentyController::zbiorczeDokumenty' => ['privates', '.service_locator.DTVd5hp', 'get_ServiceLocator_DTVd5hpService', false],
            'App\\Controller\\DokumentyController::zbiorczeMiesiacDokumenty' => ['privates', '.service_locator.DTVd5hp', 'get_ServiceLocator_DTVd5hpService', false],
            'App\\Controller\\MessageController::delete' => ['privates', '.service_locator.U9RtBWL', 'get_ServiceLocator_U9RtBWLService', false],
            'App\\Controller\\MessageController::edit' => ['privates', '.service_locator.U9RtBWL', 'get_ServiceLocator_U9RtBWLService', false],
            'App\\Controller\\MessageController::index' => ['privates', '.service_locator.gsw_Zt2', 'get_ServiceLocator_GswZt2Service', false],
            'App\\Controller\\MessageController::show' => ['privates', '.service_locator.U9RtBWL', 'get_ServiceLocator_U9RtBWLService', false],
            'App\\Controller\\RegisterController::registerAction' => ['privates', '.service_locator.SZ.XAwj', 'get_ServiceLocator_SZ_XAwjService', false],
            ...
            'App\\Controller\\AdminController::dodajUsersAdmin' => '?',
            'App\\Controller\\AdminController::dokumenty' => '?',
            'App\\Controller\\AdminController::editUserAdmin' => '?',
            'App\\Controller\\AdminController::infoUserAdmin' => '?',
            'App\\Controller\\DokumentyController::daneDokumenty' => '?',
            'App\\Controller\\DokumentyController::deleteDokument' => '?',
            'App\\Controller\\DokumentyController::detailsDokumenty' => '?',
            'App\\Controller\\DokumentyController::detailsMiesiecznyDokumenty' => '?',
            'App\\Controller\\DokumentyController::edytujDokumenty' => '?',
            'App\\Controller\\DokumentyController::indexDokumenty' => '?',
            'App\\Controller\\DokumentyController::testDokumenty' => '?',
            'App\\Controller\\DokumentyController::testDokumentyId' => '?',
            'App\\Controller\\DokumentyController::usunDokument' => '?',
            'App\\Controller\\DokumentyController::zbiorczeDokumenty' => '?',
            'App\\Controller\\DokumentyController::zbiorczeMiesiacDokumenty' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AVeAvYqjy4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.easyadmin'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AczB9sWQIw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('R1EB0TQ0B6', 0, $this->getParameter('container.build_id'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QZUsubEzIG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5Awn3A+F6R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDoctrine_ResultCachePoolService()
    {
        ...
        $this->privates['doctrine.result_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('-LaV6OIGcZ', 0, ($this->targetDir.''.'/pools'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL))));
    ...
    {
        return $this->privates['doctrine.system_cache_pool'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XtObm63ZNB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Form\\DokumentType' => ['privates', 'App\\Form\\DokumentType', 'getDokumentTypeService', false],
            'App\\Form\\MessageType' => ['privates', 'App\\Form\\MessageType', 'getMessageTypeService', false],
            'App\\Form\\UserAdminEditType' => ['privates', 'App\\Form\\UserAdminEditType', 'getUserAdminEditTypeService', false],
            ...
            'App\\Form\\DokumentType' => '?',
            'App\\Form\\MessageType' => '?',
            'App\\Form\\UserAdminEditType' => '?',
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/agro'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/message'), [0 => 'IS_AUTHENTICATED_ANONYMOUSLY'], NULL);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'easyadmin.config' => [
                'site_name' => 'Agro24 - <em style="font-size: 80%;">Uproszczona ewidencja przychodów i rozchodów</em>',
                'user' => [
                    'display_name' => true,
                    'display_avatar' => true,
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.App\\Command\\ExpireUserCommand',
            ],
        ];
    }
}
