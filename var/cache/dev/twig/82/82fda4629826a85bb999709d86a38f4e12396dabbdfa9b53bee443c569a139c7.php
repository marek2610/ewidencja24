...
class __TwigTemplate_410ab2bd7e4aa5cb0914e4849cf35fd76dd45e54ba2609cc5a60f88d2f9b3c33 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <p>
    Wiadomość błędu: ";
        // line 18
        echo twig_escape_filter($this->env, (isset($context["status_text"]) || array_key_exists("status_text", $context) ? $context["status_text"] : (function () { throw new RuntimeError('Variable "status_text" does not exist.', 18, $this->source); })()), "html", null, true);
        echo "
  </p>
  <p>
    Komunikat błędu: ";
        // line 21
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["exception"]) || array_key_exists("exception", $context) ? $context["exception"] : (function () { throw new RuntimeError('Variable "exception" does not exist.', 21, $this->source); })()), "message", [], "any", false, false, false, 21), "html", null, true);
        echo "
  </p>
  ";
        // line 23
...
";
    ...
    {
        return array (  116 => 23,  111 => 21,  105 => 18,  99 => 15,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
  ...
  <p>
    Kod błędu: {{ status_code }}
  </p>
  <p>
    Wiadomość błędu: {{ status_text }}
  </p>
  <p>
    Komunikat błędu: {{ exception.message }}
  </p>
  {{ dump() }}
{% endblock %}", "@Twig/Exception/error404.html.twig", "/home/hystou/public_html/agro24/templates/bundles/TwigBundle/Exception/error404.html.twig");
    }
}
